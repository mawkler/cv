...
#alta(
  ...
  [
    ...
    #experience(none)[Software engineering consultant][Omegapoint][2021 --- present][Stockholm]

    RESTful back-end development with Azure Functions in TypeScript/Node.

    #experience(none)[Software developer][Ericsson][2016 --- 2017][Kista, Stockholm]
    ...
    #experience(none)[Programming and CAD teacher][Hello World!][2018][Stockholm]
    ...
    #experience(none)[Computer science lab teacher][Uppsala University][2017, 2019][Uppsala]
    ...
    #experience(none)[Master Programme in Computer and Information Engineering, 300 c --- Specialization in Software Engineering][Uppsala University][2015-2021][Uppsala]
    ...
    #experience(none)[Music programme][Wik's Folkhögskola][2014-2015][Uppsala]

    Music education focused on musical variety and expression in song writing as well as live performance and music theory.

    #experience(none)[Natural Science Program with aesthetic orientation music][Viktor Rydberg Gymnasium Odenplan][2011-2014][Stockholm]
